            	...
            	$score1   = 0;
                  ...
                  for($i=0;$i<$jumlah;$i++){
                      ...
                      // jika memilih
                          ...
                          $query1  = mysqli_query($koneksi, "SELECT * FROM pengetahuan_kuantitatif WHERE id='$nomor' AND jawaban='$jawaban'");
                          ...
                          $jawaban20  = $pilihan20[$nomor20];
                          $query2  = mysqli_query($koneksi, "SELECT * FROM pengetahuan_kuantitatif WHERE id='$nomor20' AND jawaban='$jawaban20'");
